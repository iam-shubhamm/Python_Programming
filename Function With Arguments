...
greetings("Shubham")     # Shubham is argument 
greetings()       # required an argument to run code

def intro(course_name, instructor_name):
    print("Welcome to ", course_name, instructor_name)

intro("Python", "Shubham")
...
greetings2("Shubham", 'Shivam', 'Rohit')
...
# print_details(name = "Shubham", age = 24, city = "Buxar")

print_details(name = "Shubham", age = 24)
