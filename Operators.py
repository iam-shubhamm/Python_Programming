...
a = 10 
b = 20
print(a>10 and b<10) # and operator             # Rule for 'and' operator
print(a==10 and b==20)                          # 1. True + True = True 
                                                # 2. True + False = False
                                                # 3. False + False = False
print(a==10 and b==20)
print(a==10 or b<10) # or operator              # Rule for 'or' operator
                                                #True + False = True 
print(not(a==10 and b==20))                     # 'not' operator
